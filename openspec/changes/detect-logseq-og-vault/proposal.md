...
Vault Rig cannot safely operate on a folder until it knows that the folder is a Logseq OG vault and has resolved its actual pages, journals, filename, and journal-date conventions. Guessing these values risks incorrect reads or destructive writes.
