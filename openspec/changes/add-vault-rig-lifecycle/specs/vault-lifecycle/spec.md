...
Defines safe, repeatable lifecycle behavior for applying and removing Vault Rig-managed files without taking ownership of a vault's knowledge or unrelated configuration.
...
Installation SHALL write only declared Vault Rig-managed files or bounded managed regions and MUST NOT rewrite canonical pages, journals, assets, or Logseq configuration.
...
- **WHEN** uninstall removes a Vault Rig-managed root-instruction region
